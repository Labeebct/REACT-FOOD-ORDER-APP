  ...
  return (
    <div className="flex w-full h-[calc(100vh-4.5rem)] flex-wrap">
      ...
      <div className="hidden lg:flex relative flex-col items-center gap-5 w-[50%] h-full">
        ...
        <button className="absolute px-10 py-3 hover:bg-[#FF5A00] font-poppins font-[700] tracking-wider top-[21rem] right-24 bg-[#FF7A00] rounded-3xl text-white cursor-pointer">
          EXPLORE
        </button>

...
function HomeBurger() {
  return (
    <div className="w-full my-24 h-auto justify-around flex-wrap flex">
      <div className="w-1/2 h-[40rem] flex items-center  flex-col flex-1">
      ...
      <div className="w-1/2 h-[40rem] min-w-[300px] flex items-center  justify-center  flex-1">
        <img src={burger} className="h-[28rem] w-[30rem] md:h-[34rem] md:w-[36rem] hover:scale-[1.04] ease-linear duration-75" alt="burger image" />
      </div>
    </div>
  );
}

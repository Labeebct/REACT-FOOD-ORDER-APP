...
function OrderFrame() {
  return (
    <div className='w-full h-[12rem] flex border border-slate-200 border-opacity-20'>
      ...
      <div className="flex items-center justify-center pb-8 font-bold font-inter text-[.6rem] md:text-[.8rem] h-full text-[#e4e4e4] w-[7rem]">12-02-2024</div>
      <div className='h-full w-[8rem]  flex items-center justify-center'>
        <h3 className='text-green-600 text-[.6rem] md:text-[.9rem] font-poppins font-bold pb-8 tracking-wider'>DELIVERED</h3>
      </div>
    </div>
  )
}

    ...
    <main className="w-full h-[calc(100vh-4.5rem)] flex items-center justify-center">
      <section className="w-[33%] mb-2 xl:w-[66%] min-w-[370px] h-[34rem] bg-white overflow-hidden rounded-[.6rem] flex justify-center">
        ...
        <form className="w-1/2 text-black min-w-[310px] h-full flex  flex-col items-center px-[4.6rem] py-9 gap-4 flex-1">
          ...
          <div className="w-full h-auto flex flex-col mt-2 gap-1">
            <label
              htmlFor="email"
            ...
            <label
              htmlFor="email"
              className="font-roboto mt-1 pl-2 text-[gray] text-[.8rem]"
            >
              Email
            </label>
            <input
          ...
          <p className="text-[.8rem] text-[gray] font-poppins mt-1">
          ...
          <button className="px-8 py-2 hover:bg-[#FF5A00] font-poppins font-[700] tracking-wider bg-[#FF7A00] rounded-3xl text-white cursor-pointer">
            SIGNUP
          </button>
        </form>
      </section>

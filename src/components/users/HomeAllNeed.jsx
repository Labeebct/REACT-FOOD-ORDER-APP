...
function HomeAllNeed() {
  ...
  return (
    <div className="w-full h-auto my-32 flex justify-around flex-wrap border-1">
      <div className="w-[50%] min-w-[360px] h-[30rem] flex items-center justify-center lg:border-r border-white border-opacity-20">
        <img
          src={CartoonCheff}
      ...
      <div className="w-[50%] p-4 flex-1 h-[30rem] flex flex-col justify-around items-center">

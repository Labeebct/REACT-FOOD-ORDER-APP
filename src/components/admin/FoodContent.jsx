      ...
      <table className='border border-slate-200 border-opacity-20 w-full h-auto'>
        ...
        { data.map((foods)=> (
           ...
           <tr className='cursor-pointer' key={foods._id}>
            ...
            <td className='font-[300] border border-slate-200 border-opacity-20 text-center font-roboto text-[.95rem] py-4'><img src={'https://food.labio.shop/'+ foods.foodImg} className='mx-auto w-24 h-17' alt="" /></td>
